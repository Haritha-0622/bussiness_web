...
export const Footer: React.FC = () => {
  return (
    <>
      <footer className="bg-slate-900 text-slate-300 text-xs py-12 pb-24 md:pb-12 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2 pt-1">
                <a
                  ...
                  className="px-3 py-1.5 rounded-lg bg-blue-700 text-white font-bold hover:bg-blue-600"
                >
                  Call Now
                </a>
                <a
          ...
          <div className="pt-6 border-t border-slate-800 text-center text-slate-400 text-[11px]">
            © {new Date().getFullYear()} SANKAR’S Accounts & Auditing. All Rights Reserved. Pondicherry - 605005.
          </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-slate-200 p-2.5 md:hidden flex items-center justify-around gap-2 shadow-2xl">
        <a
          href={`tel:${BUSINESS_INFO.contacts.phonePrimary}`}
          className="flex-1 flex items-center justify-center py-2.5 px-3 rounded-xl bg-blue-700 text-white text-xs font-bold shadow"
        >
